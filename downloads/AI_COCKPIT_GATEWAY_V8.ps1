...
$controllerStateFile = "C:\AI_Cockpit_OneClick_Starter\V8_CONTROLLER_STATE.json"
...
try {
    $listener.Start()
    Write-Host ("AI Cockpit Gateway V8: http://127.0.0.1:{0}/?live=1" -f $Port) -ForegroundColor Green
