...
.scalp-tv{background:#08090B!important;border:1px solid #272A30!important;border-radius:8px!important;padding:0!important;overflow:hidden!important;color:#d7dadd}
.scalp-tv-toolbar{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:12px 14px;border-bottom:1px solid #272A30;background:#101114}
.scalp-tv-title{display:flex;align-items:center;gap:10px}.scalp-tv-title h2{margin:0!important;padding:0!important;border:0!important;color:#e7e9eb!important;font-size:15px!important}.scalp-tv-title span{font-size:11px;color:#6b6f76}
.scalp-tv-legend{display:flex;gap:12px;font-size:11px;color:#6b6f76}.scalp-tv-legend b{color:#c7cacd}
.scalp-strip{display:grid;grid-template-columns:repeat(5,minmax(205px,1fr));gap:10px;background:#08090B;padding:10px}
.scalp-card{position:relative;background:#101114;border:1px solid #272A30;border-radius:8px;min-height:280px;padding:14px;overflow:hidden}
...
.scalp-head{display:flex;align-items:flex-start;justify-content:space-between;gap:8px}.scalp-symbol{min-width:0}.scalp-symbol strong{display:block;color:#c7cacd;font-size:13px;font-weight:600;line-height:1.25;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.scalp-symbol small{display:block;color:#63676e;font-size:10.5px;margin-top:3px}
.scalp-signal{font-size:10.5px;font-weight:800;padding:4px 8px;border-radius:999px;background:#15171B;color:#9aa0a6;border:1px solid #272A30}.long .scalp-signal{background:#0d2b23;color:#1fc79a;border-color:#164536}.short .scalp-signal{background:#341418;color:#f0616c;border-color:#4a1f24}.block .scalp-signal{background:#2c2110;color:#d9a13f;border-color:#4a3a1c}.wait .scalp-signal{background:#15171B;color:#6b6f76}
.scalp-price-row{display:flex;align-items:flex-end;justify-content:space-between;gap:8px;margin-top:14px}.scalp-price{font-size:26px;font-weight:700;letter-spacing:-.02em;color:#f4f5f6}.scalp-change{font-size:12px;font-weight:700}.scalp-change.up{color:#1fc79a}.scalp-change.down{color:#f0616c}.scalp-change.flat{color:#6b6f76}
.scalp-spark{height:54px;margin:8px -2px 6px}.scalp-spark svg{width:100%;height:54px;display:block}.scalp-spark .grid{stroke:#272A30;stroke-width:1}.scalp-spark .line{fill:none;stroke:#4d5b68;stroke-width:2;vector-effect:non-scaling-stroke}
.scalp-order{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:#1a1c20;border:1px solid #272A30;border-radius:6px;overflow:hidden;margin:8px 0}.scalp-order span{background:#15171B;padding:7px 6px;font-size:9.5px;color:#63676e}.scalp-order b{display:block;margin-top:3px;font-size:12px;color:#c7cacd;font-weight:600}.scalp-order .stop b{color:#f0616c}.scalp-order .target b{color:#1fc79a}
.scalp-metrics{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;background:#1a1c20;border:1px solid #272A30;border-radius:6px;overflow:hidden}.scalp-metrics span{background:#15171B;padding:7px 6px;font-size:9.5px;color:#63676e}.scalp-metrics b{display:block;margin-top:3px;font-size:11px;color:#c7cacd;font-weight:600}
.scalp-foot{margin-top:8px;color:#63676e;font-size:9.5px;line-height:1.4;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
