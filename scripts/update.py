...
<header><div><h1>AIトレードコクピット Ver.3.5</h1><div class="sub">日本株全市場／持ち越しLONG・SHORT発動価格</div></div><div><span class="tag">{phase}</span><div class="sub">{data['updated_at']}／日経想定 {day_range}</div></div></header><main>
...
<section id="tv-watchlist-export" class="card wide"><h2>⑤-X TradingView監視リスト出力</h2>
