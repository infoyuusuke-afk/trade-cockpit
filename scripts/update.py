...
document.addEventListener("DOMContentLoaded",()=>{{
 ...
 function tvSrc(sym){{const p=new URLSearchParams({{symbol:sym,interval:"D",hidesidetoolbar:"0",symboledit:"1",saveimage:"0",toolbarbg:"0b1119",studies:"[]",theme:"dark",style:"1",timezone:"Asia/Tokyo",withdateranges:"1",hideideas:"1",studies_overrides:"{{}}",overrides:"{{}}",enabled_features:"[]",disabled_features:"[]",locale:"ja"}});return "https://www.tradingview.com/widgetembed/?"+p.toString();}}
 function chart(x){{if(!x.code)return `<div class="chart-empty">チャートデータ更新待ち</div>`;return `<iframe class="tv-embed" src="${{tvSrc("TSE:"+x.code)}}" frameborder="0" scrolling="no" allowtransparency="true"></iframe>`;}}
