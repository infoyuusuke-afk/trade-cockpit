...
<section id="ms2-live-top5" class="card wide ms2-live-panel">
 ...
 <p><a class="ms2-download" href="ms2_live/KIOXIA_MULTI_LIVE.html" target="_blank" rel="noopener">キオクシア専用・4画面LIVEを開く</a></p>
 ...
 <p class="sub">4画面LIVEは1分・3分・5分・15分足、VWAP・OR15・EMA20、板・歩み値を同時表示します。試運転中はSIM固定で実注文を送りません。</p>
